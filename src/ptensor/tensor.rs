...
mod test {
    ...
    fn test_matmul3_f16() {
        ...
        // Tensor shape is [N, K] but raw memory should be NT: N×K
    ...
    fn test_experts_matmul_silu_f16_tensor_api() {
        ...
        // shape is [E, I, H], raw memory also [E, I, H] row-major (NT)
    ...
    fn test_experts_matmul_down_f16_tensor_api() {
        ...
        // ✅ NEW contract: B is already NT (N×K) row-major in memory per expert:
        // w_nt[j * inter + kk]
